...
# # detect video path
video_path = f"{CWD}/yoga_toolkit/WarriorTwoPose/Video/detect/test4.mp4"
file_name = (video_path.split('/')[-1]).split('.')[0]
storage_path = f"{CWD}/yoga_toolkit/WarriorTwoPose/Video/output/{file_name}.mp4"
